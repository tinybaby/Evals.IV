...
!0);this.pluginCount=Z+=1;e.prop("value")&&(f=e.prop("value").split(";"));"single"===a.type?f&&1<f.length?("number"http://tisa-admin.tzdthemes.com/assets/lib/ion.rangeSlider/js/ion-rangeSlider/!==typeof a.min?a.min=parseFloat(f[0]):"number"!==typeof a.from&&(a.from=parseFloat(f[0])),"number"!==typeof a.max&&(a.max=parseFloat(f[1]))):f&&1===f.length&&"number"!==typeof a.from&&(a.from=parseFloat(f[0])):"double"===a.type&&(f&&1<f.length?("number"http://tisa-admin.tzdthemes.com/assets/lib/ion.rangeSlider/js/ion-rangeSlider/!==typeof a.min?a.min=parseFloat(f[0]):"number"!==typeof a.from&&(a.from=parseFloat(f[0])),"number"http://tisa-admin.tzdthemes.com/assets/lib/ion.rangeSlider/js/ion-rangeSlider/!==typeof a.max?a.max=parseFloat(f[1]):"number"!==typeof a.to&&(a.to=parseFloat(f[1]))):f&&1===f.length&&("number"http://tisa-admin.tzdthemes.com/assets/lib/ion.rangeSlider/js/ion-rangeSlider/!==typeof a.min?a.min=parseFloat(f[0]):"number"!==typeof a.from&&(a.from=parseFloat(f[0]))));"number"!==typeof a.min&&(a.min=10);"number"!==typeof a.max&&(a.max=100);"number"!==typeof a.from&&(a.from=a.min);"number"!==typeof a.to&&(a.to=a.max);"number"===typeof e.data("min")&&(a.min=parseFloat(e.data("min")));"number"===typeof e.data("max")&&(a.max=parseFloat(e.data("max")));"number"===typeof e.data("from")&&(a.from=parseFloat(e.data("from")));
...
var c=h.fromX+(h.toX-h.fromX)/2;N=0;S=m.width()-C;O=m.width()-C;"single"http://tisa-admin.tzdthemes.com/assets/lib/ion.rangeSlider/js/ion-rangeSlider/===a.type?(n=t,n.attr("id","irs-active-slider"),T(b)):"double"===a.type&&(n=b<=c?g:p,n.attr("id","irs-active-slider"),T(b),I());n.removeAttr("id");n=null}});J&&(K.on("touchend",function(){s&&(s=v=!1,n.removeAttr("id"),n=null,"double"===a.type&&I(),X())}),K.on("touchmove",function(a){s&&(R=a.originalEvent.touches[0].pageX,T())}));ba();V();a.hasGrid&&ea();a.disable&&(q.addClass("irs-disabled"),q.append('<span class="irs-disable-mask"></span>'))},
ba=function(){l=m.width();C=t?t.width():g.width();B=l-C},H=function(b,d,c){ba();Q=!1;n=d;n.attr("id","irs-active-slider");d=n.offset().left;W=d+(b.pageX-d)-n.position().left;"single"http://tisa-admin.tzdthemes.com/assets/lib/ion.rangeSlider/js/ion-rangeSlider/===a.type?S=m.width()-C:"double"===a.type&&("from"===c?(N=0,O=parseInt(p.css("left"),10)):(N=parseInt(g.css("left"),10),O=m.width()-C))},I=function(){var a=g.width(),d=c.data(g[0],"x")||parseInt(g[0].style.left,10)||g.position().left,e=(c.data(p[0],"x")||parseInt(p[0].style.left,10)||p.position().left)-d;D[0].style.left=
d+a/2+"px";D[0].style.width=e+"px"},T=function(b){var d=R-W,d=b?b:R-W;"single"http://tisa-admin.tzdthemes.com/assets/lib/ion.rangeSlider/js/ion-rangeSlider/===a.type?(0>d&&(d=0),d>S&&(d=S)):"double"===a.type&&(d<N&&(d=N),d>O&&(d=O),I());c.data(n[0],"x",d);X();b=Math.round(d);n[0].style.left=b+"px"},X=function(){var b={input:e,slider:q,fromNumber:0,toNumber:0,fromPers:0,toPers:0,fromX:0,toX:0},d=a.max-a.min,U;"single"http://tisa-admin.tzdthemes.com/assets/lib/ion.rangeSlider/js/ion-rangeSlider/===a.type?(b.fromX=c.data(t[0],"x")||parseInt(t[0].style.left,10)||t.position().left,b.fromPers=b.fromX/B*100,U=d/100*b.fromPers+a.min,b.fromNumber=Math.round(U/
