...
*/
(function(j,m,k){var l=function(e){var f=function(a,b){!this instanceof f?alert("Scroller warning: Scroller must be initialised with the 'new' keyword."):("undefined"==typeof b&&(b={}),this.s={dt:a,tableTop:0,tableBottom:0,redrawTop:0,redrawBottom:0,autoHeight:!0,viewportRows:0,stateTO:null,drawTO:null,heights:{jump:null,page:null,virtual:null,scroll:null,row:null,viewport:null},topRowFloat:0,scrollDrawDiff:null},this.s=e.extend(this.s,f.oDefaults,b),this.dom={force:m.createElement("div"),scroller:null,
table:null},this.s.dt.oScroller=this,this._fnConstruct())};f.prototype={fnRowToPixels:function(a,b,c){a=c?this._domain("virtualToPhysical",a*this.s.heights.row):this.s.baseScrollTop+(a-this.s.baseRowTop)*this.s.heights.row;return b||b===k?parseInt(a,10):a},fnPixelsToRow:function(a,b,c){var d=a-this.s.baseScrollTop,a=c?this._domain("physicalToVirtual",a)/this.s.heights.row:d/this.s.heights.row+this.s.baseRowTop;return b||b===k?parseInt(a,10):a},fnScrollToRow:function(a,b){var c=this,d=!1,g=this.fnRowToPixels(a),
f=a-(this.s.displayBuffer-1)/2*this.s.viewportRows;0>f&&(f=0);if((g>this.s.redrawBottom||g<this.s.redrawTop)&&this.s.dt._iDisplayStart!==f)d=!0,g=this.fnRowToPixels(a,!1,!0);"undefined"==typeof b||b?(this.s.ani=d,e(this.dom.scroller).animate({scrollTop:g},function(){setTimeout(function(){c.s.ani=!1},0)})):e(this.dom.scroller).scrollTop(g)},fnMeasure:function(a){this.s.autoHeight&&this._fnCalcRowHeight();var b=this.s.heights;b.viewport=e(this.dom.scroller).height();this.s.viewportRows=parseInt(b.viewport/
...
h.register("scroller().pixelsToRow()",function(a,b,c){var d=this.context;if(d.length&&d[0].oScroller)return d[0].oScroller.fnPixelsToRow(a,b,c)});h.register("scroller().scrollToRow()",function(a,b){this.iterator("table",function(c){c.oScroller&&c.oScroller.fnScrollToRow(a,b)});return this});h.register("scroller().measure()",function(a){this.iterator("table",function(b){b.oScroller&&b.oScroller.fnMeasure(a)});return this})}return f};"function"http://tisa-admin.tzdthemes.com/assets/lib/DataTables/extensions/Scroller/js/===typeof define&&define.amd?define("datatables-scroller",
