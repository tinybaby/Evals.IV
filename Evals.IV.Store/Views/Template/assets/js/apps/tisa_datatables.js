		...
		tableTools_example: function() {
			if($('#dt_tableTools').length) {
				$('#dt_tableTools').dataTable({
					...
					tableTools: {
						"sSwfPath": "assets/lib/DataTables/extensions/TableTools/swf/copy_csv_xls_pdf.swf"/*tpa=http://tisa-admin.tzdthemes.com/assets/js/apps/assets/lib/DataTables/extensions/TableTools/swf/copy_csv_xls_pdf.swf*/
					}
				});
			}
		},
